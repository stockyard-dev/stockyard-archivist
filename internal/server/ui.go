...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> ARCHIVIST</h1>
...
var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "title", "label": "Title", "type": "text"}, {"name": "filename", "label": "Filename", "type": "text"}, {"name": "mime_type", "label": "Mime Type", "type": "text"}, {"name": "size_bytes", "label": "Size Bytes", "type": "integer"}, {"name": "folder", "label": "Folder", "type": "text"}, {"name": "tags", "label": "Tags", "type": "text"}, {"name": "notes", "label": "Notes", "type": "textarea"}, {"name": "created_at", "label": "Created At", "type": "text"}];
